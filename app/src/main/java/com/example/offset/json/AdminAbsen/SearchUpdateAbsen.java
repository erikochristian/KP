...
public class SearchUpdateAbsen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_update_absen);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ...
                Intent intent = new Intent(SearchUpdateAbsen.this, UpdateAbsen.class);
    ...
    private final Response.Listener<String> onPostsLoaded = new Response.Listener<String>() {
        ...
        public void onResponse(String response) {
            try{
                ...
                AdapterAbsen customAdapterAbsen = new AdapterAbsen(SearchUpdateAbsen.this, R.layout.item_absen, absens);
    ...
    private final Response.ErrorListener onPostsError = new Response.ErrorListener() {
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            Toast.makeText(SearchUpdateAbsen.this,"Koneksi gagal. Cek koneksi ke server!",Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(SearchUpdateAbsen.this, SearchAbsen.class);
        i.putExtra("crud","u");
        startActivity(i);
        finish();
    }
    ...
    public void logout(View view){
        Intent i = new Intent(SearchUpdateAbsen.this, Login_Activity.class);
        startActivity(i);
        SearchUpdateAbsen.this.finish();
    }
