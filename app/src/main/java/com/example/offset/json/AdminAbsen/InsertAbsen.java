...
public class InsertAbsen extends AppCompatActivity {

    String NIK_ABSEN = "-", SFT = "-", TMSK = "-", TKLR = "-", JMSK = "0", JKLR = "0", TR = "0", TR2 = "0";
    String MESIN = "-", UPDT = "-", GOLJAM = "-", SSL = "0", JKLR2 = "0";
    EditText t_NIK, t_SFT, t_TMSK, t_TKLR, t_JMSK, t_JKLR, t_TR, t_TR2, t_MESIN, t_SSL, t_JKLR2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insert_absen);

        //link to web service
        ENDPOINT = "http://"+getResources().getString(R.string.ip)+"/KP/insertAbsen";
    ...
    public void insert_absen(View view) throws ParseException {
        ...
        if (t_NIK.getText().length() == 0|| t_TMSK.getText().length() == 0|| t_TKLR.getText().length() == 0 || t_JMSK.getText().length() == 0 || t_JKLR.getText().length() == 0 ) {
            Toast.makeText(InsertAbsen.this, "NIK, tanggal masuk, tanggal keluar, jam masuk dan jam keluar tidak boleh kosong", Toast.LENGTH_LONG).show();
    ...
    private final Response.Listener<String> onPostsLoaded = new Response.Listener<String>() {
        ...
        public void onResponse(String response) {
            Toast.makeText(InsertAbsen.this, "Data absen berhasil ditambahkan", Toast.LENGTH_LONG).show();
            Intent back = new Intent(InsertAbsen.this, AdminAbsen.class);
            startActivity(back);
            InsertAbsen.this.finish();
    ...
    private final Response.ErrorListener onPostsError = new Response.ErrorListener() {
        ...
        public void onErrorResponse(VolleyError error) {
            ...
            Toast.makeText(InsertAbsen.this,"Koneksi gagal. Cek koneksi ke server!",Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private final Response.Listener<String> onPostsLoaded_goljam = new Response.Listener<String>() {
        ...
        public void onResponse(String response) {
            ...
            ArrayAdapter adapter_goljam = new ArrayAdapter(InsertAbsen.this, android.R.layout.simple_spinner_item, list_spin_goljam);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(InsertAbsen.this, AdminAbsen.class);
        startActivity(i);
        finish();
    }

    public void logout(View view){
        Intent i = new Intent(InsertAbsen.this, Login_Activity.class);
        startActivity(i);
        InsertAbsen.this.finish();
    }
}
